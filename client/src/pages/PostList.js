...
function PostList() {
  ...
  const fetchPosts = async () => {
    try {
      ...
      console.log("Selected category before fetching:", selectedCategory);  // Nuevo console.log
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-50 rounded-lg shadow-lg mt-10 max-w-4xl">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
        <div className="mb-4 lg:mb-0">
          ...
          <select
            ...
            onChange={(e) => {
              console.log("Selected Category:", e.target.value); // Verifica el valor seleccionado
